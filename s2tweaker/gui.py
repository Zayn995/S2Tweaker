...
class App(WorkbenchMixin, ctk.CTk):
    ...
    def _build_body(self):
        ...
        self._check(f, "rq_jobs_multi",
                    ...
                    "1.40 still showed missing texts and lost completed-job markers. "
                    "This experimental revision reapplies markers for remaining "
                    "ready-to-return jobs and extends the original translation "
                    "files for ALL installed languages. Both changes need a game "
                    "test. The larger pak conflicts with mods replacing those "
                    "same translation files. Use a save "
