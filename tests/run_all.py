...
ORDER = [
    ...
    "test_weapon_choices.py",
    "test_gui_weapon_choices.py",
    "test_animation_sync.py",
    "test_consumable_sync.py",
    "test_consumable_wiring.py",
    "test_ingame_menu.py",
    "test_player_recovery_controls.py",
    "test_companion_generation.py",
    "test_sound_sync.py",
    "test_native_remaining_controls.py",
    "test_reload_scope.py",
    "test_sparse_control_patches.py",
    "test_npc_patch_compatibility.py",
