# S2Tweaker 1.40.1 — job text and return-marker repairs

This release includes repairs for missing multi-job text and disappearing
return markers after another job is handed in. **The job changes are experimental
and NOT PLAY-TESTED.** The reported in-game problems remain open for confirmation.
...
NPC-equipment feature is introduced by this release. Bullet Time remains
deferred. Issues #9 and #19 remain open.

[Job guide](https://github.com/Zayn995/S2Tweaker/blob/v1.40.1/docs/REPEATABLE_JOBS_REPAIR.md)
and [language-loading research](https://github.com/Zayn995/S2Tweaker/blob/v1.40.1/docs/JOB_LOCALIZATION_LOADING_FOLLOWUP.md).

Source: tag `v1.40.1`; build with `.github/workflows/build.yml` and
